...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~i8RWXIxa#iybrnXE1nS1dzZRlxFRj7X6AH3k0Zpl-oxlcPx88jKA",  // Your bot's session ID (keep it secure)
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Miky-Prime",     // Sticker pack name
